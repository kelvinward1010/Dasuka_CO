...
export default function ChiPhiNguyenLieuTable(): JSX.Element {
  ...
  // const [, setTotal] = useRecoilState(total1LvcState);
  ...
  const columns: TableColumnsType<any> = [
    ...
    {
      title: customTitle("TG", getTitle("lvc")?.left),
      align: "right",
      width: "6%",
    ...
    {
      title: customTitle("TG", getTitle("lvc")?.right),
      align: "right",
      width: "6%",
