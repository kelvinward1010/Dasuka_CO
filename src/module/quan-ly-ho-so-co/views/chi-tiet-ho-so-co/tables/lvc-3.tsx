...
import { DataTb3LvcCTState } from "@/store/datanvl/atom";
import { total3LvcState } from "@/store/total/atom";
...
export default function ChiPhiPhanBottTable(props: dataTable): JSX.Element {
  ...
  const [, setTotal] = useRecoilState(total3LvcState);
  const [, setDataX] = useRecoilState<any[]>(DataTb3LvcCTState);
