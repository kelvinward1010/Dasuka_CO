...
import { checkMaterialResultCTC } from "../../config/result-form";
...
export function CCTable(): JSX.Element {
  ...
  const columns: TableColumnsType<any> = [
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        const checkCTC = checkMaterialResultCTC(
          hsCode,
          sanPham,
          "cc",
          record,
        ...
        return (
          <Typography.Text
            title={getMaterialErrorMessage(record, checkCTC)}
            type={hsCode ? (checkCTC ? "danger" : undefined) : undefined}
    ...
    {
      title: customTitle("TG", getTitle("ctc")?.left),
      align: "right",
      width: "6%",
    ...
    {
      title: customTitle("TG", getTitle("ctc")?.right),
      align: "right",
      width: "6%",
  ...
  return (
    <>
      <Table
        className="tb-nvl"
        scroll={{ y: 340 }}
        style={{ boxShadow: "0px 0px 1px 0px rgba(0, 0, 0, 0.25)" }}
        id={"cc"}
        bordered
        columns={columns}
        pagination={false}
