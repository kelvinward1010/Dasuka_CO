...
import { DataTb2LvcCTState } from "@/store/datanvl/atom";
import { total2LvcState } from "@/store/total/atom";
...
export default function ChiPhiPhanCongttTable(props: dataTable): JSX.Element {
  ...
  const [, setTotal] = useRecoilState(total2LvcState);
  const [, setDataX] = useRecoilState<any[]>(DataTb2LvcCTState);
