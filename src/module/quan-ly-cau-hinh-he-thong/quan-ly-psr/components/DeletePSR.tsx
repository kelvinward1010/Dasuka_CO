...
import { useDeletePSR } from "../api/deletePSR";
import styles from "../style.module.scss";

interface Props {
  id: string;
  number_legal_documents: string;
}

export function DeletePSR({ id, number_legal_documents }: Props): JSX.Element {
