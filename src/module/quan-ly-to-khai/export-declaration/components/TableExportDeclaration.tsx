...
import { useExportDeclarations } from "../api/getExportDeclarations";
import { IExportDeclaration } from "../types";
import { UpdateExportDeclaration } from "./UpdateExportDeclaration";
...
export function TableExportDeclaration(): JSX.Element {
  ...
  const ListExportDeclarations = useExportDeclarations({
    params: {
      pageIndex,
      pageSize,
