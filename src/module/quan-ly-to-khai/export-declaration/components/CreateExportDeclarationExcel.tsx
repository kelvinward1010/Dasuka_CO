...
import { useCreateExportDeclarationExcel } from "../api/createExportDeclarationExcel";

export function CreateExportDeclarationExcel(): JSX.Element {
  ...
  const createExportDeclaration = useCreateExportDeclarationExcel({
    config: {
      onSuccess: (data) => {
        if (data) {
